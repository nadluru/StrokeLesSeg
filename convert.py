...
if __name__ == '__main__':
    ...
    output_path = 'atlasv2/raw/nnUNet_raw_data/Task100_ATLAS_v2'
    ...
    input_path_1 = os.path.join(input_path, 'train/derivatives/ATLAS')
    ...
    for folder in file_path_list:
        ...
        for file_name in os.listdir(folder):
            ...
            if 'T1w.nii.gz' in fil: # the suffix is .nii.gz
                ...
                out_name = os.path.basename(fil).replace('label-L_desc-T1lesion_mask.nii.gz', 'T1w.nii.gz')
