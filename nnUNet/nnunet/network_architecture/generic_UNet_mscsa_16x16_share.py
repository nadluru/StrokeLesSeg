...
from nnunet.network_architecture.layers import *
...
class Generic_UNet_MSCSA_16x16_Share(Generic_UNet):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        attn = [AttentionLocationCSwinMultiScale2SeparateConvShare, AttentionLocationCSwinMultiScale2SeparateConvShare]
