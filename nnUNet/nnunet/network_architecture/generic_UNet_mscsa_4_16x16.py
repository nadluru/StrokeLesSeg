...
class Generic_UNet_MSCSA_4_16x16(Generic_UNet):
    ...
    def forward(self, x):
        ...
        feats = torch.cat([out_embed(out, shape) for out, out_embed in zip(outs, self.out_embed)], dim=1)
