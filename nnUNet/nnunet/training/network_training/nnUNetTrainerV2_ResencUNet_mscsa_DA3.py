...
from nnunet.network_architecture.generic_ResencUNet_mscsa import FabiansUNet_MSCSA
...
class nnUNetTrainerV2_ResencUNet_MSCSA_DA3(nnUNetTrainerV2_ResencUNet_DA3):
