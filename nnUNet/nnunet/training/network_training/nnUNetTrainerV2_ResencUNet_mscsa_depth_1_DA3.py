...
from nnunet.network_architecture.generic_ResencUNet_mscsa_depth_1 import FabiansUNet_MSCSA
from nnunet.training.network_training.nnUNet_variants.architectural_variants.nnUNetTrainerV2_ResencUNet_DA3 \
    import nnUNetTrainerV2_ResencUNet_DA3


class nnUNetTrainerV2_ResencUNet_MSCSA_Depth_1_DA3(nnUNetTrainerV2_ResencUNet_DA3):
    ...
    def initialize_network(self):
        ...
        self.network = FabiansUNet_MSCSA(self.num_input_channels, self.base_num_features, blocks_per_stage_encoder, 2,
